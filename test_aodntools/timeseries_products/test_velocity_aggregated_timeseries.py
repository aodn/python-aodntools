...
from aodntools.timeseries_products.velocity_aggregated_timeseries import (
    velocity_aggregated,
)
...
class TestVelocityAggregatedTimeseries(BaseTestCase):
    EXPECTED_OUTPUT_FILE = os.path.join(
        TEST_ROOT,
        "IMOS_ANMN-NRS_VZ_20180816_NRSROT_FV01_velocity-aggregated-timeseries_END-20191018_C-20200623.nc",
    )

    def test_velocity_aggregated(self):
        output_file, bad_files = velocity_aggregated(
